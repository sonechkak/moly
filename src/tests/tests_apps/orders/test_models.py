...
def test_order_creation(client, user, order):
...
@pytest.mark.django_db
def test_order_product_creation(client, order_product, order, product):
...
@pytest.mark.django_db
def test_order_product_price_validation(client, order, product):
